...
// The synthetic population used for the agents in the model, and the mobility choice
// decision tree is generated by the CS_activityBased model.
// It is based on data from the National Household Transit Survey.
// The model is calculated for different CBSA, to generate synthetic populations and
// mobility type choice decision trees per CBSA
// CBSA 14460: Boston-Cambridge-Quincy, MA-NH metropolitan area.
public final int CBSA = 14460;
public String SYNTHETIC_POPULATION_DATA_FILEPATH = "data/simPop_CBSA_14460.csv";
// CBSA 35620: New York-Northern New Jersey-Long Island, NY-NJ-PA
// public final int CBSA = 35620;
// public String SYNTHETIC_POPULATION_DATA_FILEPATH = "data/simPop_CBSA_35620.csv";


public final int NUM_AGENTS = 3200;
